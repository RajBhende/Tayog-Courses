...
export default function StudentDashboardPage() {
  ...
  // Fetch people data for progress and top performers
        ...
        <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  <div className="flex items-baseline gap-2">
                    <span className="text-4xl font-bold">
                      {peopleData?.currentStudentAverage ?? 0}
                    </span>
                  ...
                  <Progress
                    value={peopleData?.currentStudentAverage ?? 0}
                    className="h-2"
                  />
                </div>
              )}
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              ) : peopleData?.topPerformers && peopleData.topPerformers.length > 0 ? (
                <>
                  {peopleData.topPerformers.map((performer) => (
                    <div
                      key={performer.id}
